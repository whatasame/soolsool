...
import static shop.soolsool.auth.code.AuthErrorCode.TOKEN_ERROR;
...
class TokenProviderTest {
    ...
    @BeforeEach
    void setUp() {
        tokenProvider = new TokenProvider("7Z2R7Z2R7KSR6rCE642w66qo64SI66y07Z6Y65Ok7JeI7Ja0Cg==", 123456789);
    }
    ...
    void validateTokenTestWithTimeOut() {
        ...
        final String expired =
                "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIzIiwiaWF0IjoxNjkyNDI4NDk0LCJST0xFX1RZUEUiOiJDVVNUT01FUiIsImV4cCI6MTY5MjQyODQ5NH0.ywzhJeUI3eVxHKE7IlDexJSnb5zTMLJaDxkuQ6kI2h4";
    ...
    @NullAndEmptySource
    @ParameterizedTest
    void validateTokenTestWithNullAndEmptyKey(final String accessKey) {
        // given & when & then
