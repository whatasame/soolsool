...
class ReceiptItemBrewTest {
    ...
    void create() {
        /* given */
        final String name = "SOJU";

        /* when & then */
        assertThatCode(() -> new ReceiptItemBrew(name)).doesNotThrowAnyException();
    }
    ...
    void equalsAndHashCode() {
        /* given */
        final ReceiptItemBrew origin = new ReceiptItemBrew("우아한");
        final ReceiptItemBrew same = new ReceiptItemBrew("우아한");
        final ReceiptItemBrew different = new ReceiptItemBrew("형제들");
