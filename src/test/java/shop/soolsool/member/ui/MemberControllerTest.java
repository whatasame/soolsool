...
class MemberControllerTest extends AcceptanceTest {
    ...
    void createMember() {
        ...
        MemberAddRequest memberAddRequest =
                new MemberAddRequest("구매자", "kim@email.com", "baedal", "김배달", "010-0000-0000", "0", "잠실역");
    ...
    void getMember() {
        ...
        // then
        assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
        MemberDetailResponse memberDetailResponse = response.jsonPath().getObject("data", MemberDetailResponse.class);
    ...
    void modifyMember() {
        ...
        MemberModifyRequest modifyRequest = new MemberModifyRequest("modify_password", "modify_name", "modify_address");
