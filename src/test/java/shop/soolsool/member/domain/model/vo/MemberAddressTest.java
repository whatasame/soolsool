...
class MemberAddressTest {
    ...
    void create() {
        ...
        /* when & then */
        assertThatCode(() -> new MemberAddress(address)).doesNotThrowAnyException();
    }

    @ParameterizedTest
    @NullAndEmptySource
    @DisplayName("회원 주소가 null 혹은 공백일 경우 SoolSoolException을 던진다.")
    ...
    @Test
    @DisplayName("회원 주소가 100자 초과일 경우 SoolSoolException을 던진다.")
