...
class LiquorCtrTest {
    ...
    void create() {
        ...
        /* when & then */
        assertThatCode(() -> new LiquorCtr(1L)).doesNotThrowAnyException();
    }
    ...
    void createFailWithOutNullLiquorId() {
        ...
        /* when & then */
        assertThatCode(() -> LiquorCtr.builder().build()).isExactlyInstanceOf(NullPointerException.class);
    }
    ...
    void getCtr() {
        /* given */
        final LiquorCtr liquorCtr = new LiquorCtr(1L, 2L, 1L);
