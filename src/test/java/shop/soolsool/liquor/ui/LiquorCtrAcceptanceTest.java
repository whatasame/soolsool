...
import shop.soolsool.acceptance.fixture.RestLiquorCtrFixture;
...
class LiquorCtrAcceptanceTest extends AcceptanceTest {
    ...
    void setUpData() {
        ...
        redissonClient.getMapCache(LIQUOR_CTR_KEY).put(새로, new RedisLiquorCtr(0L, 0L));
    }
    ...
    void getLiquorCtr() {
        ...
        /* when */
        final LiquorCtrDetailResponse response = RestAssured.given()
                .log()
                .all()
                ...
                .extract()
                .jsonPath()
                .getObject("data", LiquorCtrDetailResponse.class);
