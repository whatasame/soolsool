...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("select o from Order o join fetch o.receipt r join fetch r.receiptItems ri" + " where o.id = :orderId")
    ...
    @Query(
            value = "select cast(count(o.id) as double) / nullif((select count(sub_ri.id) "
