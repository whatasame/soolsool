package shop.soolsool.core.aop;
...
public class RequestLoggingAspect {
    ...
    @Around("@annotation(shop.soolsool.core.aop.RequestLogging)")
    ...
    private String mapToFormatted(final Map<String, String[]> params) {
        final String formattedParams =
                params.entrySet().stream().map(this::formatParam).collect(Collectors.joining("&"));
