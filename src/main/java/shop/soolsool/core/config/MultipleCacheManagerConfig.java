package shop.soolsool.core.config;
...
import shop.soolsool.core.infra.CaffeineCacheType;
import shop.soolsool.core.infra.RedisCacheType;
...
public class MultipleCacheManagerConfig extends CachingConfigurerSupport {
    ...
    public MultipleCacheManagerConfig(
            @Value("${spring.redis.host}") final String host, @Value("${spring.redis.port}") final int port) {
        this.host = host;
        this.port = port;
    }
    ...
    public CacheManager redisCacheManager(final RedisConnectionFactory redisConnectionFactory) {
        ...
        cacheConfiguration.put(
                RedisCacheType.LIQUOR_FIRST_PAGE.getCacheName(),
                redisCacheConfiguration.entryTtl(
                        Duration.ofSeconds(RedisCacheType.LIQUOR_FIRST_PAGE.getExpireSeconds())));
    ...
    public CacheManager caffeineCacheManager() {
        final List<CaffeineCache> caches = Arrays.stream(CaffeineCacheType.values())
