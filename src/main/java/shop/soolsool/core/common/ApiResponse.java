...
public class ApiResponse<T> {
    ...
    @JsonCreator
    public ApiResponse(final int status, final String code, final String message, final T data) {
        this.status = status;
        this.code = code;
    ...
    private ApiResponse(final ResultCode resultCode, final T data) {
        this(resultCode.getStatus(), resultCode.getCode(), resultCode.getMessage(), data);
    }

    private ApiResponse(final ResultCode resultCode) {
        this(resultCode.getStatus(), resultCode.getCode(), resultCode.getMessage(), null);
    }
