...
public class StatisticRedisImpl implements StatisticRedis {
    ...
    @Override
    public StatisticLiquors saveTop5StatisticLiquorsBySalePrice(final StatisticLiquors statisticLiquors) {
    ...
    @Override
    public StatisticLiquors saveTop5StatisticLiquorsBySaleQuantity(final StatisticLiquors statisticLiquors) {
