...
import shop.soolsool.statistics.domain.model.StatisticLiquorImpl;
...
public class StatisticRepositoryImpl implements StatisticRepository {
    ...
    public StatisticLiquors findTop5LiquorsBySalePrice() {
        final StatisticLiquors statisticLiquors = statisticRedis.findTop5StatisticLiquorsBySalePrice();
        ...
        return statisticRedis.saveTop5StatisticLiquorsBySalePrice(new StatisticLiquors(top5LiquorAndSalePrices));
    }

    @Override
    public StatisticLiquors findTop5LiquorsBySaleQuantity() {
        final StatisticLiquors statisticLiquors = statisticRedis.findTop5StatisticLiquorsBySaleQuantity();
        ...
        final List<StatisticLiquorImpl> top5LiquorAnsSaleQuantities =
                statisticJpaRepository.findTop5LiquorsAndSaleQuantity().stream()
                        .map(StatisticLiquorImpl::from)
                        .collect(Collectors.toUnmodifiableList());
        return statisticRedis.saveTop5StatisticLiquorsBySaleQuantity(new StatisticLiquors(top5LiquorAnsSaleQuantities));
    }
    ...
    private void saveRedisTop5StatisticsLiquorsBySalePrice() {
        ...
        statisticRedis.saveTop5StatisticLiquorsBySalePrice(new StatisticLiquors(statisticsLiquors));
    }
    ...
    private void saveRedisTop5StatisticsLiquorsBySaleQuantity() {
        ...
        statisticRedis.saveTop5StatisticLiquorsBySaleQuantity(new StatisticLiquors(statisticsLiquors));
    }
}
