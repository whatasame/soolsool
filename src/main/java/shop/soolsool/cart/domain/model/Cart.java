...
import static shop.soolsool.cart.code.CartErrorCode.EXCEED_MAX_CART_SIZE;
import static shop.soolsool.cart.code.CartErrorCode.EXISTS_CART_ITEM;
import static shop.soolsool.cart.code.CartErrorCode.NOT_EQUALS_MEMBER;
import static shop.soolsool.cart.code.CartErrorCode.NULL_LIQUOR;
import static shop.soolsool.cart.code.CartErrorCode.STOPPED_LIQUOR;
...
public class Cart {
    ...
    public List<CartItem> getCartItems() {
        return cartItems.stream().collect(Collectors.toUnmodifiableList());
    }
