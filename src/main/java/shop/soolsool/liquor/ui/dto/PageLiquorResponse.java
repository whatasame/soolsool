...
public class PageLiquorResponse {
    ...
    public PageLiquorResponse(
            final boolean hasNext, final Long nextCursorId, final List<LiquorElementResponse> liquors) {
        this.hasNext = hasNext;
        this.nextCursorId = nextCursorId;
        this.liquors = liquors;
    }

    public static PageLiquorResponse of(final Pageable pageable, final List<LiquorElementResponse> liquors) {
