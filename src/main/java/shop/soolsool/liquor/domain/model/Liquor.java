...
import shop.soolsool.liquor.domain.model.converter.LiquorAlcoholConverter;
import shop.soolsool.liquor.domain.model.converter.LiquorBrandConverter;
import shop.soolsool.liquor.domain.model.converter.LiquorImageUrlConverter;
import shop.soolsool.liquor.domain.model.converter.LiquorNameConverter;
import shop.soolsool.liquor.domain.model.converter.LiquorPriceConverter;
import shop.soolsool.liquor.domain.model.converter.LiquorStockCountConverter;
import shop.soolsool.liquor.domain.model.converter.LiquorVolumeConverter;
...
public class Liquor extends BaseEntity {
    ...
    public Liquor(
            ...
            final int volume) {
        this(null, brew, region, status, name, price, brand, imageUrl, alcohol, volume);
    }
